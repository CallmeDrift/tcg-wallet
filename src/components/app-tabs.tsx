...
export default function AppTabs() {
  ...
  return (
    <NativeTabs
      ...
      {/** Use available icons from assets/tabIcons. Missing icons replaced with home/explore placeholders */}
      ...
      <NativeTabs.Trigger name="add-card">
        <NativeTabs.Trigger.Label>Agregar</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon src={require('@/assets/images/tabIcons/home.png')} renderingMode="template" />
      </NativeTabs.Trigger>

      <NativeTabs.Trigger name="profit-value">
        <NativeTabs.Trigger.Label>Valor</NativeTabs.Trigger.Label>
